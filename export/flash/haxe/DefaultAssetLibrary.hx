...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/logo Rad Star1.png", __ASSET__assets_logo_rad_star1_png);
		type.set ("assets/logo Rad Star1.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		addExternal("assets/logo Rad Star1.png", "image", "assets/logo Rad Star1.png");
...
@:keep class __ASSET__assets_logo_rad_star1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
